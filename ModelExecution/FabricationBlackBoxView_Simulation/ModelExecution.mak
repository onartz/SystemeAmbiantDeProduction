...
FLAGSFILE=
RULESFILE=
OMROOT="C:\Users\nartz5\IBM\Rational\Rhapsody\8.0.3\Share"
RHPROOT="C:\Program Files\IBM\Rational\Rhapsody\8.0.3"
...
TARGET_NAME=ModelExecution

all : $(TARGET_NAME)$(EXE_EXT) ModelExecution.mak

TARGET_MAIN=MainModelExecution
...
Fabrication.obj : Fabrication.cpp Fabrication.h    FabricationPkg.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Fabrication.obj" "Fabrication.cpp" 



FabricationPkg.obj : FabricationPkg.cpp FabricationPkg.h    
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"FabricationPkg.obj" "FabricationPkg.cpp" 
...
###############################################################################
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) ModelExecution.mak 
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) ModelExecution.mak
	@echo Building library $@
	$(LIB_CMD) $(LIB_FLAGS) /out:$(TARGET_NAME)$(LIB_EXT) $(OBJS) $(ADDITIONAL_OBJS) $(LIBS)

clean:
	@echo Cleanup
	if exist Fabrication.obj erase Fabrication.obj
	if exist FabricationPkg.obj erase FabricationPkg.obj
